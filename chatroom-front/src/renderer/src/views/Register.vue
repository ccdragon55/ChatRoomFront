    ...
    <div class="login-form">
      ...
      <el-form ref="form" label-width="80px">
        ...
        <el-form-item label="邮箱" prop="email">
          <el-input id="email" v-model="email" type="text" placeholder="请输入邮箱" clearable style="width: 90%;"></el-input>
        </el-form-item>
        <el-form-item label="密码" prop="password">
          <el-input id="password" v-model="password" type="text" placeholder="请输入密码" clearable style="width: 90%;"></el-input>
        </el-form-item>
        <!-- <el-form-item label="手机号" prop="phonenumber">
        ...
        <el-form-item label="验证码" prop="verificationCode">
          <div class="form-group">
            <div class="input-container">
              <el-input  v-model="verificationCode" type="text" placeholder="请输入验证码" clearable></el-input>
              <el-image class="image-checkCode" :src="checkCodeImage" @click="changeCheckCode" fit="contain" />
            </div>
          </div>
        </el-form-item>
