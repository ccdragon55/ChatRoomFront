<template>
  <div class="login-form">
    ...
    <div class="form-group">
      ...
      <input type="password" id="password" v-model="password" required show-password clearable/>
    </div>

    <div class="form-group">
      <label for="password2">请再次确认密码:</label>
      <input type="password" id="password2" v-model="password2" required show-password clearable/>
    </div>
